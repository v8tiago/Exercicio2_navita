...
CREATE SEQUENCE [TomboSequence] AS int START WITH 1000 INCREMENT BY 1 NO MINVALUE NO MAXVALUE NO CYCLE;

GO

ALTER TABLE [Patrimonios] ADD [NTombo] int NOT NULL DEFAULT (NEXT VALUE FOR TomboSequence);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20200826230032_AddNTombo', N'3.1.7');
